...
![Mosyle Admin Console]({{ "/assets/img/mosyle-admin-on-demand-admin.png" | relative_url | absolute_url }})

To activate, the user navigates to the Mosyle Self-Service app, clicks on Admin On-Demand, and makes the request.

{% include elements/video.html
   provider="youtube" id="bkIj3i2TUqI"
   privacy=true autoplay=true muted=true
   wow="wow fadeInUp" %}
